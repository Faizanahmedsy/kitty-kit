    ...
    <>
      <div className="min-h-[calc(100vh-150px)]">
        <div className="flex justify-center items-center bg-gradient-to-t from-blue-100 to-white  dark:from-blue-900 dark:to-black md:rounded-b-full ">
          <h3 className="md:text-4xl text-2xl md:py-24 py-10 pt-20 md:pt-auto px-10 md:px-auto font-bold bg-gradient-to-t from-slate-800 to-slate-50 dark:from-slate-50 dark:to-slate-400 bg-clip-text text-transparent">
